...
function bones_register_sidebars() {
    ...
    register_sidebar(array(
        'id' => 'author',
        'name' => 'Author Sidebar',
        'description' => 'used on author pages',
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h4 class="widgettitle">',
        'after_title' => '</h4>',
...
{ 
    ...
    wp_register_style( 'bootstrap', get_template_directory_uri() . '/library/css/bootstrap.css', array(), '1.1.7', 'all' );
    wp_register_style( 'orbit', get_template_directory_uri() . '/library/css/orbit.css', array(), '1.0', 'all' );
    wp_register_style( 'bootstrap-responsive', get_template_directory_uri() . '/library/css/responsive.css', array(), '1.1.7', 'all' );
    wp_register_style( 'wp-bootstrap', get_template_directory_uri() . '/style.css', array(), '1.1.7', 'all' );
